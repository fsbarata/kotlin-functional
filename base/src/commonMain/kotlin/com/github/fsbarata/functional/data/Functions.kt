...
@JvmName("partialSuspending")
inline fun <A, R> partial(crossinline f: sF1<A, R>, a: A): sF0<R> = { f(a) }
...
@JvmName("partial2Suspending")
inline fun <A, B, R> partial2(crossinline f: sF2<A, B, R>, a: A, b: B): sF0<R> = { f(a, b) }
...
@JvmName("partialSuspending")
inline fun <A, B, R> partial(crossinline f: sF2<A, B, R>, a: A): sF1<B, R> = { f(a, it) }
...
@JvmName("partialLastSuspending")
inline fun <A, B, R> partialLast(crossinline f: sF2<A, B, R>, b: B): sF1<A, R> = { f(it, b) }
...
@JvmName("partialSuspending")
inline fun <A, B, C, R> partial(crossinline f: sF3<A, B, C, R>, a: A): sF2<B, C, R> = { b, c -> f(a, b, c) }
...
@JvmName("partial2Suspending")
inline fun <A, B, C, R> partial2(crossinline f: sF3<A, B, C, R>, a: A, b: B): sF1<C, R> = { c -> f(a, b, c) }
...
@JvmName("partial3Suspending")
inline fun <A, B, C, R> partial3(crossinline f: sF3<A, B, C, R>, a: A, b: B, c: C): sF0<R> = { f(a, b, c) }
...
@JvmName("partialLastSuspending")
inline fun <A, B, C, R> partialLast(crossinline f: sF3<A, B, C, R>, c: C): sF2<A, B, R> = { a, b -> f(a, b, c) }
...
@JvmName("partialLast2Suspending")
inline fun <A, B, C, R> partialLast2(crossinline f: sF3<A, B, C, R>, b: B, c: C): sF1<A, R> = { a -> f(a, b, c) }
...
@JvmName("partialSuspending")
inline fun <A, B, C, D, R> partial(crossinline f: sF4<A, B, C, D, R>, a: A): sF3<B, C, D, R> =
	{ b, c, d -> f(a, b, c, d) }
...
@JvmName("partial2Suspending")
inline fun <A, B, C, D, R> partial2(crossinline f: sF4<A, B, C, D, R>, a: A, b: B): sF2<C, D, R> =
	{ c, d -> f(a, b, c, d) }
...
@JvmName("partial3Suspending")
inline fun <A, B, C, D, R> partial3(crossinline f: sF4<A, B, C, D, R>, a: A, b: B, c: C): sF1<D, R> =
	{ d -> f(a, b, c, d) }
...
@JvmName("partial4Suspending")
inline fun <A, B, C, D, R> partial4(crossinline f: sF4<A, B, C, D, R>, a: A, b: B, c: C, d: D): sF0<R> =
	{ f(a, b, c, d) }
...
@JvmName("partialLastSuspending")
inline fun <A, B, C, D, R> partialLast(crossinline f: sF4<A, B, C, D, R>, d: D): sF3<A, B, C, R> =
	{ a, b, c -> f(a, b, c, d) }
...
@JvmName("partialLast2Suspending")
inline fun <A, B, C, D, R> partialLast2(crossinline f: sF4<A, B, C, D, R>, c: C, d: D): sF2<A, B, R> =
	{ a, b -> f(a, b, c, d) }
...
@JvmName("partialLast3Suspending")
inline fun <A, B, C, D, R> partialLast3(crossinline f: sF4<A, B, C, D, R>, b: B, c: C, d: D): sF1<A, R> =
	{ a -> f(a, b, c, d) }
...
@JvmName("currySuspending")
inline fun <A, B, R> curry(crossinline f: sF2<A, B, R>): suspend (A) -> suspend (B) -> R = { a -> partial(f, a) }
...
@JvmName("currySuspending")
inline fun <A, B, C, R> curry(crossinline f: sF3<A, B, C, R>): suspend (A) -> suspend (B) -> suspend (C) -> R =
	{ a -> { b -> partial2(f, a, b) } }
...
@JvmName("uncurrySuspending")
inline fun <A, B, R> uncurry(crossinline f: (suspend (A) -> suspend (B) -> R)): sF2<A, B, R> =
	{ a, b -> f(a).invoke(b) }
...
@JvmName("uncurrySuspending")
inline fun <A, B, C, R> uncurry(crossinline f: (suspend (A) -> suspend (B) -> suspend (C) -> R)): sF3<A, B, C, R> =
	{ a, b, c -> f(a).invoke(b).invoke(c) }
...
@JvmName("uncurrySuspending")
inline fun <A, B, C, R> uncurry(crossinline f: (suspend (A, B) -> suspend (C) -> R)): sF3<A, B, C, R> =
...
@JvmName("flipSuspending")
inline fun <A, B, R> flip(crossinline f: sF2<A, B, R>): sF2<B, A, R> = { b, a -> f(a, b) }
...
@JvmName("flipSuspending")
inline fun <A, B, R> flip(crossinline f: (suspend (A) -> suspend (B) -> R)): suspend (B) -> suspend (A) -> R =
	{ b -> { a -> f(a).invoke(b) } }
...
@ExperimentalFunctions
@JvmName("invokeSuspending")
inline operator fun <A, B, R> sF2<A, B, R>.invoke(a: A): sF1<B, R> = partial(this, a)
...
@ExperimentalFunctions
@JvmName("invokeSuspending")
inline operator fun <A, B, C, R> sF3<A, B, C, R>.invoke(a: A): sF2<B, C, R> = partial(this, a)
...
@ExperimentalFunctions
@JvmName("invokeSuspending")
operator fun <A, B, C, D, R> sF4<A, B, C, D, R>.invoke(a: A): sF3<B, C, D, R> = partial(this, a)
