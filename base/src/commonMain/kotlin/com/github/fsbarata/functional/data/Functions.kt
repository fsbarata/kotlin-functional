...
@JvmName("partialExt")
inline fun <A, B, R> F2<A, B, R>.partial(a: A, b: B): F0<R> = partial(this, a, b)
inline fun <A, B, R> partial(crossinline f: F2<A, B, R>, a: A, b: B): F0<R> = { f(a, b) }
...
@JvmName("partialExt")
inline fun <A, B, C, R> F3<A, B, C, R>.partial(a: A, b: B): F1<C, R> = partial(this, a, b)
inline fun <A, B, C, R> partial(crossinline f: F3<A, B, C, R>, a: A, b: B): F1<C, R> = { c -> f(a, b, c) }

@JvmName("partialExt")
inline fun <A, B, C, R> F3<A, B, C, R>.partial(a: A, b: B, c: C): F0<R> = partial(this, a, b, c)
inline fun <A, B, C, R> partial(crossinline f: F3<A, B, C, R>, a: A, b: B, c: C): F0<R> = { f(a, b, c) }
...
@JvmName("partialLastExt")
inline fun <A, B, C, R> F3<A, B, C, R>.partialLast(b: B, c: C): F1<A, R> = partialLast(this, b, c)
inline fun <A, B, C, R> partialLast(crossinline f: F3<A, B, C, R>, b: B, c: C): F1<A, R> = { a -> f(a, b, c) }
...
inline fun <A, B, C, R> curry(crossinline f: F3<A, B, C, R>): (A) -> (B) -> (C) -> R = { a -> { b -> f.partial(a, b) } }
