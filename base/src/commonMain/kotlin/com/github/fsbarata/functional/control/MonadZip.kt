...
fun <M, A, B> zip(monad1: MonadZip<M, A>, monad2: Functor<M, B>) = zip(monad1, monad2, ::Pair)
fun <M, A, B> zipT(monad1: MonadZip<M, A>, monad2: Functor<M, B>) = zip(monad1, monad2, ::Tuple2)
