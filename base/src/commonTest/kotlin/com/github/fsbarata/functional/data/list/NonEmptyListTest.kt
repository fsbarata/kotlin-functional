...
internal class NonEmptyListTest:
	...
	@Test
	fun startWith() {
		assertEquals(nelOf(9, 3), nelOf(3).startWithItem(9))
		assertEquals(nelOf(5, 1, 3, 3), nelOf(1, 3, 3).startWithItem(5))
	...
	@Test
	fun maxBy() {
		assertEquals(9, nel1.maxBy { it })
		assertEquals(5, nel2.maxBy { it % 3L })
		assertEquals(4, nel3.maxBy { it % 5L })
	}

	@Test
	fun maxOf() {
		assertEquals(9L, nel1.maxOf { it.toLong() })
		assertEquals(2.5, nel2.maxOf { (it % 3L) + 0.5 })
		assertEquals(4, nel3.maxOf { it % 5 })
	}
	...
	fun minBy() {
		...
		assertEquals(5, nel3.minBy { it % 5L })
	}
